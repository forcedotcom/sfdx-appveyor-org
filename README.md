...
7) From you JWT-Based connected app on Salesforce, retrieve the generated `Consumer Key` and store in a AppVeyor environment variable named `CONSUMER_KEY` using the AppVeyor UI.
